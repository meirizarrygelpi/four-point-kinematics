...
\begin{equation}
	C_{\red{123}} = C_{\red{134}} = s \left[s - 4 m^{2} \right], \qquad C_{\red{124}} = C_{\red{234}} = t \left[t - 4 m^{2} \right].
\end{equation}
Similarly, for the \blue{blue} tetrahedron you have
\begin{equation}
	C_{\blue{123}} = C_{\blue{134}} = t \left[t - 4 m^{2} \right], \qquad C_{\blue{124}} = C_{\blue{234}} = u \left[u - 4 m^{2} \right].
\end{equation}
Finally, for the \green{green} tetrahedron you have
\begin{equation}
	C_{\green{123}} = C_{\green{134}} = u \left[u - 4 m^{2} \right], \qquad C_{\green{124}} = C_{\green{234}} = s \left[s - 4 m^{2} \right].
\end{equation}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
